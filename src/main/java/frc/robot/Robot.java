...
public class Robot extends TimedRobot {
  ...
  public static TriggerServo servoTrigger;
  ...
  public void teleopInit() {
    ...
    //System.out.println("enabled: "+ c.enabled());
    //System.out.println("presure switch: " + c.getPressureSwitchValue());
    //System.out.println("Compressor current: " + c.getCurrent());
    //count++;
    
    if (m_autonomousCommand != null) {
      m_autonomousCommand.cancel();
    }
    RobotContainer.m_drivetrain.setDefaultCommand(new DriveArcade());
